...
public class EmailPhlushTests
{
    ...
    {
        var emailPhlush = new EmailPhlush(_mockEmailService.Object, _email, _password, "scan");
    ...
    {
        var emailPhlush = new EmailPhlush(_mockEmailService.Object, _email, _password, "unknown");
